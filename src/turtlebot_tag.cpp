...
int main(int argc, char **argv) {
  ...
  // transformPointsServer = n.advertiseService("/ObstacleLaserScan", transformPoints);
  ...
  laserScanSubscriber = n.subscribe("/LaserScan", 10000, laserScanCallback);
  odometrySubscriber = n.subscribe("/odom", 10000, odometeryCallback);
  getTransformClient = n.serviceClient<GetTransformationSrv>("/GetTransformation");
