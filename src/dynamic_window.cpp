...
#include "srv/ObstacleMsg.h"
#include "srv/CheckPointSrv.h"
#include "srv/GetFreePathSrv.h"
#include "srv/GetCommandVelSrv.h"

#include <math.h> // sqrt

using cobot_msgs::CobotDriveMsg;
using srv::ObstacleMsg;
using srv::CheckPointSrv;
using srv::GetFreePathSrv;
using srv::GetCommandVelSrv;
...
int main(int argc, char **argv) {
  ...
  checkPointServer = n.advertiseService("/CheckPoint", checkPoint);
  getFreePathServer = n.advertiseService("/GetFreePath", getFreePath);
  getCommandVelocityServer = n.advertiseService("/GetCommandVel", getCommandVelocity);

  obstaclePublisher = n.advertise<ObstacleMsg>("/Obstacles", 10000);
